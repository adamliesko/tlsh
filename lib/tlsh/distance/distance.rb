module Distance
  # BIT_PAIRS_DIFF_TABLE is pre-calculated table that represents approximation
  ...
  #
  #
  # Source of the data can be found at:
  ...
  class << self
    ...
    def diff_total(a, b, is_len_diff)
      if is_len_diff
        ...
        # q1 diff
        q1_diff = mod_diff(a.q1_ratio, b.q1_ratio, 16)
        diff += if q1_diff <= 1
                  q1_diff
                else
                  (q1_diff - 1) * 12
        ...
        # q2 diff
        q2_diff = mod_diff(a.q2_ratio, b.q2_ratio, 16)
        diff += if q2_diff <= 1
                  q2_diff
                else
                  (q2_diff - 1) * 12
